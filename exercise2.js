...
// 2. Change the difficulty to 7 using bracket notation.
programming["difficulty"] = 7;
console.log(programming);

// 3. Remove the jokes key using delete.
delete programming.jokes;
console.log(programming);

// 4. Add new key isFun with value true using dot notation.
programming.isFun = true;
console.log(programming);

// 5. Use map() to format and log the languages array.
let formattedLanguages = programming.languages.map(
